            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Jenis Dokumen" name="id" value="<?php echo $jd->id ?>">
                          <label for="exampleInputEmail1">Username</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="username" value="<?php echo $jd->username ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Password</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="password" value="<?php echo $jd->password ?>">
                        </div>
                        <div class="form-group">
                          <label>Role</label>
                            <select class="form-control select2" style="width: 100%;" name="role_id" value="<?php echo $jd->role_id ?>">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputEmail1"  name="no_telp" value="<?php echo $jd->no_telp ?>">
                        </div>
                      </div>
                      <!-- /.card-body -->
