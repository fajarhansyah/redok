            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Data Pengelolah Dokumen</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($data_dokumen as $dd) :?>
                    <form action="<?php echo base_url(). 'c_pengelolah_dokumen/update_data_dokumen' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama Dokumen</label>
                          <input type="hidden" name="id" class="form-control" value="<?php echo $dd->id_dokumen ?>" >
                          <input type="text" class="form-control" id="exampleInputEmail1" name="nama_dokumen" value="<?php echo $dd->nama_dokumen ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <?php foreach ($jenis_dokumen as $jd) : ?>
                                <option value="<?php echo $jd->id_jenis_dokumen;?>"
                                        <?php 
                                            if ($jd->id_jenis_dokumen == $dd->jenis_dokumen) {
                                              echo "selected";
                                            }
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail" name="pic" value="<?php echo $dd->pic ?>">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                            <select class="form-control select2" style="width: 100%;" name="status" >
                                <option value="Dicabut" <?=$dd->status == "Dicabut" ? "selected" :null ?>>Dicabut</option>
                                <option value="Mencabut" <?=$dd->status == "Mencabut" ? "selected" :null ?>>Mencabut</option>
                                <option value="Diubah" <?=$dd->status == "Diubah" ? "selected" :null ?>>Di Ubah</option>
                                <option value="Mengubah" <?=$dd->status == "Mengubah" ? "selected" :null ?>>Mengubah</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" class="custom-file-input" id="exampleInputFile" name="upload_dokumen" value="<?php echo $dd->upload_dokumen ?>">
