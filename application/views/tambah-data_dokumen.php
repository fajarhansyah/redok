        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="<?php echo base_url(). 'c_data_dokumen/tambah_data_dokumen' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach ($jenis_dokumen as $jd) : ?>
                              <option><?php echo $jd->nama_jenis_dokumen?></option>
                              <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="bag_or_keb">
                              <?php foreach ($bagian_kebun as $bk) : ?>
                                <option><?php echo $bk->nama?></option>
                              <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2bs4" multiple="multiple" data-placeholder="" style="width: 100%;" name="akses_for[]">
                                <?php foreach ($user as $usr) : ?>
                                    <option><?php echo $usr->username?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
