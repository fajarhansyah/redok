        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="<?php echo base_url(). 'c_jenis_pengelolah_dokumen/tambah_jenis_dokumen' ?>" method="post">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Status" name="status_jenis_dokumen">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Keterangan</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Keterangan Dokumen" name="keterangan">
                        </div>
                      </div>
                      <!-- /.card-body -->
