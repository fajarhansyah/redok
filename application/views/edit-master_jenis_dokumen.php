            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Jenis Dokumen</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($jenis_dokumen as $jd) :?>
                    <form action="<?php echo base_url(). 'c_master_jenis_dokumen/update_jenis_dokumen' ?>" method="post">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama Jenis Dokumen</label>
                          <input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Jenis Dokumen" name="id" value="<?php echo $jd->id ?>">
