        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="<?php echo base_url(). 'c_master_jenis_dokumen/tambah_jenis_dokumen' ?>" method="post">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama Jenis Dokumen</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Jenis Dokumen" name="nama_jenis_dokumen">
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-2">
                                  <input type="number" class="form-control" onKeyPress="if(this.value.length==2) return false;" placeholder="Tahun" name="durasi_tahun">
                                </div>
                                <div class="col-2">
                                  <input type="number" class="form-control" onKeyPress="if(this.value.length==2) return false;" placeholder="Bulan" name="durasi_bulan">
                                </div>
                                <div class="col-2">
                                  <input type="number" class="form-control" onKeyPress="if(this.value.length==2) return false;" placeholder="Hari" name="durasi_tgl">
                                </div>
                              </div>
                        </div>
                      </div>
